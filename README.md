...
## Environments
- Preview: https://main--aristocratgaming-demo--jazhou-adobe.aem.page/
- Live: https://main--aristocratgaming-demo--jazhou-adobe.aem.live/
...
1. Open the `aristocratgaming-demo` directory in your favorite IDE and start coding :)
